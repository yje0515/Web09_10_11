		...
		<div id="logomain">
			...
			<div id="login">
				<ul>
					...
					<li>|</li>
					<li><a
						href="http://localhost:8080/Web09_10_11/BoardServlet?command=board_list">고객센터</a></li>
					<li></li>
					<li></li>
					...
					<li><a href="http://localhost:8080/Web09_10_11/memberUpdate.do?userid=${loginUser.userid}"><img src=img/loginicon1.png
							alt="로그인아이콘1"></a></li>
					<li></li>
					<c:if test="${loginUser.admin==1 }"><!--  관리자라면 설정아이콘이 보이고 상품등록 페이지에 접근 가능 -->
							<li><a 
								href="http://localhost:8080/Web09_10_11/productList.do?userid=${loginUser.userid}"><img style="width:30px"
									src=img/settingIcon.png alt="관리자설정"></a></li>
						</c:if>
						<c:if test="${loginUser.admin==0 }"><!-- 일반회원이라면 장바구니아이콘이 보임-->
							<li><a
								href="http://localhost:8080/Web09_10_11/memberUpdate.do?userid=${loginUser.userid}"><img
